                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('book_category_id') is-invalid @enderror" id="book_category_id" name="book_category_id">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @if (old('book_category_id', $book->book_category_id) == $category->id) selected @endif>
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jumlah_buku') is-invalid @enderror" id="jumlah_buku"
                                        placeholder="Jumlah Buku" value="{{ old('jumlah_buku', $book->jumlah_buku) }}" name="jumlah_buku">
