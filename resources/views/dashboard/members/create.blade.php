...
@section('title-header', 'Tambah Data Anggota')
@section('breadcrumb')
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-transparent border-0 text-dark">
                    <h5 class="mb-0">Formulir Tambah Data Anggota</h5>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nis') is-invalid @enderror" id="nis"
                                        placeholder="NIS Anggota" value="{{ old('nis') }}" name="nis">
                            ...
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_anggota') is-invalid @enderror" id="nama_anggota"
                                        placeholder="Nama Anggota" value="{{ old('nama_anggota') }}" name="nama_anggota">
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp"
                                        placeholder="NO. Telp Anggota" value="{{ old('no_telp') }}" name="no_telp">
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tgl_lahir') is-invalid @enderror" id="tgl_lahir"
                                        placeholder="Tanggal Lahir Anggota" value="{{ old('tgl_lahir') }}" name="tgl_lahir">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    placeholder="Alamat Anggota" name="alamat" cols="30" rows="10">{{ old('alamat') }}</textarea>
